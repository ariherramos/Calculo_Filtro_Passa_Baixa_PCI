...
filtro1=str2double(table2array(readtable('Butterworth_3_ordem.dat','Delimiter',';','ReadVariableNames',false)));
simulacao1=csvread ('sim_butterworth_3.csv',2,0);
