...
filtro1=str2double(table2array(readtable('Butterworth_7_ordem.dat','Delimiter',';','ReadVariableNames',false)));
simulacao1=csvread ('sim_butterworth_7.csv',2,0);
