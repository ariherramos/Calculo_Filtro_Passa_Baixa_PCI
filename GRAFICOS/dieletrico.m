...
filtro4=str2double(table2array(readtable('Cauer_3_ordem.dat','Delimiter',';','ReadVariableNames',false)));
filtro7=str2double(table2array(readtable('Butterworth_3_ordem.dat','Delimiter',';','ReadVariableNames',false)));
