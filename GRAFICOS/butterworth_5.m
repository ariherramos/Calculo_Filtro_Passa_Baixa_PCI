...
filtro1=str2double(table2array(readtable('Butterworth_5_ordem.dat','Delimiter',';','ReadVariableNames',false)));
simulacao1=csvread ('sim_butterworth_5.csv',2,0);
