...
filtro1=str2double(table2array(readtable('Chevyshev_5_ordem.dat','Delimiter',';','ReadVariableNames',false)));
filtro4=str2double(table2array(readtable('Cauer_5_ordem.dat','Delimiter',';','ReadVariableNames',false)));
filtro7=str2double(table2array(readtable('Butterworth_5_ordem.dat','Delimiter',';','ReadVariableNames',false)));
